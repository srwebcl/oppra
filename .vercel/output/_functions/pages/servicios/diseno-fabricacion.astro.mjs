...
const $$DisenoFabricacion = createComponent(($$result, $$props, $$slots) => {
  const services = [
    {
      title: "Ingenier\xEDa Inversa",
      image: "/images/service_reverse_eng.png",
      desc: "Levantamiento de planos de piezas y modelado CAD."
    },
    {
      title: "Mecanizado CNC",
      image: "/images/service_cnc.png",
      desc: "Torneado y fresado de alta precisi\xF3n para ejes, bujes y componentes cr\xEDticos."
    },
    {
      title: "Estructuras Met\xE1licas",
      image: "/images/service_structure.png",
      desc: "Fabricaci\xF3n y montaje de estructuras industriales, plataformas y galpones."
    },
    {
      title: "Soldadura Sanitaria",
      image: "/images/service_inox.png",
      desc: "Ca\xF1er\xEDas y estanques en acero inoxidable con soldadura TIG calificada."
    }
  ];
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Dise\xF1o y Fabricaci\xF3n Industrial | OPPRA", "description": "Servicios de dise\xF1o CAD, fabricaci\xF3n de piezas en acero inoxidable y protecciones industriales. Ingenier\xEDa de precisi\xF3n." }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "Hero", $$Hero, { "title": "Dise\xF1o y Fabricaci\xF3n Mec\xE1nica de Precisi\xF3n", "subtitle": "Soluciones de ingenier\xEDa mec\xE1nica a medida. Torneado CNC, fresado y estructuras met\xE1licas para la industria.", "imagePath": "/images/hero_mechanic.png", "ctaText": "Cotizar Fabricaci\xF3n", "useSlider": false })}  ${renderComponent($$result2, "InfiniteMarquee", $$InfiniteMarquee, {})}  ${maybeRenderHead()}<section class="py-24 bg-white relative overflow-hidden"> <div class="container-custom relative z-10"> <div class="text-center max-w-3xl mx-auto mb-12 animate-on-scroll"> <span class="inline-block py-1 px-3 rounded-full bg-blue-50 text-primary font-bold text-xs mb-4 tracking-wide uppercase border border-blue-100">
Capacidades Técnicas
</span> <h2 class="text-4xl lg:text-5xl font-extrabold mb-6 text-slate-900">
Soluciones <span class="text-accent">Especializadas</span> </h2> <p class="text-lg text-slate-600 leading-relaxed">
Tecnología de punta aplicada a la recuperación y fabricación
                    de componentes.
</p> </div> <!-- CSS SCROLL SNAP CAROUSEL --> <div class="relative group"> <!-- Navigation Buttons --> <button id="prev-btn" class="absolute left-2 md:left-0 lg:-left-12 top-1/2 -translate-y-1/2 z-20 bg-white/90 backdrop-blur-sm p-4 rounded-full shadow-2xl text-primary hover:bg-accent hover:text-white transition-all border border-slate-200 hidden md:flex items-center justify-center group-hover:scale-110" aria-label="Anterior"> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg> </button> <button id="next-btn" class="absolute right-2 md:right-0 lg:-right-12 top-1/2 -translate-y-1/2 z-20 bg-white/90 backdrop-blur-sm p-4 rounded-full shadow-2xl text-primary hover:bg-accent hover:text-white transition-all border border-slate-200 hidden md:flex items-center justify-center group-hover:scale-110" aria-label="Siguiente"> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg> </button> <div id="services-carousel" class="flex overflow-x-auto pb-12 gap-6 snap-x snap-mandatory px-4 md:px-0 -mx-4 md:mx-0 scrollbar-hide scroll-smooth"> ${services.map((service, index) => renderTemplate`<div class="snap-center shrink-0 w-[85vw] md:w-[350px] lg:w-[400px] group relative rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 bg-white"> <div class="h-64 overflow-hidden relative"> <div class="absolute inset-0 bg-slate-900/20 group-hover:bg-slate-900/10 transition-colors z-10"></div> <img${addAttribute(service.image, "src")}${addAttribute(service.title, "alt")} class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700"> </div> <div class="p-8 relative"> <div class="absolute -top-8 right-8 w-16 h-16 bg-accent rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg group-hover:-translate-y-2 transition-transform duration-300 z-20">
...
Solicitar Cotización${" "} <span class="ml-2">&rarr;</span> </a> </div> </div>`)} </div> </div> ${renderScript($$result2, "/Users/sebastianrodriguezmilla/proyectos-web/oppra/src/pages/servicios/diseno-fabricacion.astro?astro&type=script&index=0&lang.ts")} </div> </section>  <section class="py-24 bg-white overflow-hidden"> <div class="container-custom"> <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center"> <div class="order-2 lg:order-1 relative"> <div class="relative rounded-3xl overflow-hidden shadow-2xl skew-y-3 transform lg:-ml-12 border-8 border-slate-50 group"> <img src="/images/quality_control_context.png" alt="Control de Calidad" class="w-full h-full object-cover min-h-[500px] scale-105 group-hover:scale-100 transition-transform duration-1000"> <div class="absolute bottom-6 right-6 bg-white/95 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-slate-100 max-w-xs"> <div class="text-3xl font-bold text-slate-900 mb-1">
~0.01mm
...
Por qué confiar su <br><span class="text-slate-900">Producción a OPPRA</span> </h2> <p class="text-lg text-secondary mb-8 leading-relaxed font-light">
Entendemos que una pieza defectuosa puede detener toda
                        su línea. Por eso, nuestros estándares de calidad son
                        innegociables.
...
Turnos especiales para fabricación de piezas
                                    críticas durante paradas de planta.
...
Trabajamos con aceros SAE 1045, 4140, Inox
                                    304/316 y bronces de alta ley. Todo con
                                    trazabilidad.
</p> </div> </div> </div> </div> </div> </div> </section>  <section class="py-24 bg-slate-50 relative overflow-hidden"> <div class="container-custom relative z-10"> <div class="text-center mb-20 animate-on-scroll"> <span class="text-accent font-bold tracking-widest uppercase text-sm mb-2 block">Proceso de Calidad</span> <h2 class="text-3xl lg:text-4xl font-extrabold mb-6 text-slate-900">
Metodología de Trabajo
</h2> <div class="w-24 h-1 bg-accent mx-auto rounded-full"></div> <p class="text-slate-500 mt-6 max-w-2xl mx-auto">
Nuestro flujo de trabajo estandarizado garantiza la
                    consistencia y calidad en cada pieza fabricada.
...
Visita técnica a terreno para toma de medidas y
                            análisis de requerimientos.
</p> </div> <!-- Step 2 --> <div class="relative group text-center md:text-left"> <div class="w-32 h-32 md:w-32 md:h-32 mx-auto md:mx-0 bg-white rounded-full border-8 border-slate-100 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 group-hover:border-accent/20 transition-all duration-300 relative z-10"> <!-- Number in background --> <span class="absolute -top-4 -left-4 text-6xl font-black text-slate-100 group-hover:text-accent/20 transition-colors z-0">02</span> <div class="absolute inset-0 flex items-center justify-center z-10"> <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path></svg> </div> </div> <h4 class="text-xl font-bold mb-3 text-slate-900 relative z-10">
Diseño CAD
</h4> <p class="text-slate-500 text-sm leading-relaxed relative z-10">
Modelado 3D de piezas y planos de fabricación para
                            validación previa.
</p> </div> <!-- Step 3 --> <div class="relative group text-center md:text-left"> <div class="w-32 h-32 md:w-32 md:h-32 mx-auto md:mx-0 bg-white rounded-full border-8 border-slate-100 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 group-hover:border-accent/20 transition-all duration-300 relative z-10"> <!-- Number in background --> <span class="absolute -top-4 -left-4 text-6xl font-black text-slate-100 group-hover:text-accent/20 transition-colors z-0">03</span> <div class="absolute inset-0 flex items-center justify-center z-10"> <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.384-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg> </div> </div> <h4 class="text-xl font-bold mb-3 text-slate-900 relative z-10">
Fabricación
</h4> <p class="text-slate-500 text-sm leading-relaxed relative z-10">
Procesos de CNC, soldadura y tratamiento térmico
                            según norma.
</p> </div> <!-- Step 4 --> <div class="relative group text-center md:text-left"> <div class="w-32 h-32 md:w-32 md:h-32 mx-auto md:mx-0 bg-white rounded-full border-8 border-slate-100 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 group-hover:border-accent/20 transition-all duration-300 relative z-10"> <!-- Number in background --> <span class="absolute -top-4 -left-4 text-6xl font-black text-slate-100 group-hover:text-accent/20 transition-colors z-0">04</span> <div class="absolute inset-0 flex items-center justify-center z-10"> <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> </div> </div> <h4 class="text-xl font-bold mb-3 text-slate-900 relative z-10">
Control Final
</h4> <p class="text-slate-500 text-sm leading-relaxed relative z-10">
Aseguramiento de calidad, dossier técnico y despacho
                            seguro.
</p> </div> </div> </div> </div> </section>  ${renderComponent($$result2, "HomeContactSection", $$HomeContactSection, {})} ` })}`;
}, "/Users/sebastianrodriguezmilla/proyectos-web/oppra/src/pages/servicios/diseno-fabricacion.astro", void 0);

const $$file = "/Users/sebastianrodriguezmilla/proyectos-web/oppra/src/pages/servicios/diseno-fabricacion.astro";
const $$url = "/servicios/diseno-fabricacion";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$DisenoFabricacion,
    file: $$file,
    url: $$url
